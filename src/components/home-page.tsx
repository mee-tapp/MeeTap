...
// Real venue photos (licensed via Google Places, same as venue cards elsewhere)
// used only in the homepage hero collage below — one Baku old-city café, one
// seaside Istanbul restaurant, so the hero reflects both cities MeeTap covers.
const bakuCafePhoto = {
  src: "https://lh3.googleusercontent.com/place-photos/AG9NLjD8KhFGOgiVL5MfgTPIcPaZ86l-MeJKtRTyTXVfjyzZifzbxtucPfoiWpWQV0QPFgEWN2-vel_WKy8aM4uKXIK9OH_GradXmwyVHLnloANU_7dbR-nCl6XU66xAgH43aH2oP8Rym8ovLB9QSqCcP_GP8g=s1200-w800",
  attribution: "Çay Evi 145 (Google)",
};
const seasideIstanbulRestaurantPhoto = {
  src: "https://lh3.googleusercontent.com/grass-cs/ACvplmOZvn5xlxdjg-KQxoowGwhDRbLw8HBsDXYk1-fzs3nVV0OZkVTHZVI5H4K2Ipn3v6WOPn8bqyg63ha-xRdAbuFfsa7-Y_A-T_yYDMyP57gzTRJG6mBMe1U9iXj-DCVt-L4tnM6o018nXnY=s1200-w800",
  attribution: "16 Roof Bar & Restaurant - Swissotel The Bosphorus (Google)",
};
        ...
        >
          ...
          >
            <div className="relative h-[220px] w-full overflow-hidden rounded-lg">
              <img
                src={bakuCafePhoto.src}
                alt="Cozy café in Baku's Old City"
                width={1280}
                height={800}
              ...
              <span className="absolute bottom-1 right-1.5 rounded bg-background/70 px-1.5 py-0.5 text-[9px] text-muted-foreground backdrop-blur-sm">
                Photo: {bakuCafePhoto.attribution}
              </span>
            </div>
          ...
          >
            <div className="relative h-[150px] w-full overflow-hidden rounded-lg">
              <img
                src={seasideIstanbulRestaurantPhoto.src}
                alt="Seaside restaurant overlooking the Bosphorus"
                width={1280}
                height={800}
                className="h-full w-full object-cover"
              />
              <span className="absolute bottom-1 right-1.5 rounded bg-background/70 px-1.5 py-0.5 text-[9px] text-muted-foreground backdrop-blur-sm">
                Photo: {seasideIstanbulRestaurantPhoto.attribution}
              </span>
            </div>
            <p className="p-3 text-sm font-semibold">
              <Users className="mr-2 inline size-4" />
